...
/// registry metadata. [`ResolverError::CrateNotPublished`] covers both a
/// missing crate and a version the index does not list — the caller-facing
/// contract never distinguished them.
