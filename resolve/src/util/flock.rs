...
#[allow(unused_imports, reason = "for non-blocking lock callers")]
...
fn error_unsupported(_err: &std::io::Error) -> bool {
    // Platforms without a real filesystem lock syscall are treated like the
    // NFS case above: locking is reported unsupported and skipped.
    true
}
