...
export STOW_BUILD_TASK_JSON='{"task_id":"t-'"$NAME"'","crate_name":"'"$NAME"'","version":"'"$VER"'","features_json":"[\"default\"]","target":"x86_64-unknown-linux-gnu","rustc_version":"1.94.1","preserve_lockfile":true}'
